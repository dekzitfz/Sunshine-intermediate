package intermediate.bali.iak.sunshine.database;
...
import intermediate.bali.iak.sunshine.model.City;
import intermediate.bali.iak.sunshine.model.DailyForecast;
import intermediate.bali.iak.sunshine.model.Temp;
import intermediate.bali.iak.sunshine.model.WeatherItem;
import intermediate.bali.iak.sunshine.model.Weathers;
        ...
        if (total > 0) {
            if (cursor.moveToFirst()) {
                do {
                    ...
                    List<Weathers> listWeatherItems = new ArrayList<>();
